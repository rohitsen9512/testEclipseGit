...
public class Year_WDVMonthDepCalcUL
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update " + str1 + " set depreciated_opening=(depreciated_opening-(Depreciated_total-asset_total)),wdv=0.0 where asset_total < = depreciated_total and ast_id in(select id_wh from A_Ware_House where st_lease in ('Lease','UL',''))");
    }
    catch (Exception localException2)
    {

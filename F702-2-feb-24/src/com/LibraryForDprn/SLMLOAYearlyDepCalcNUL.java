...
public class SLMLOAYearlyDepCalcNUL
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update stline_depreciation set depreciated_opening=(depreciated_opening-(depreciated_total-asset_total)),wdv=0.0 where asset_total < = depreciated_total  and ast_id in(select id_wh from A_Ware_House where st_lease in ('NoLease','NUL'))");
      localStatement1.executeUpdate("update stline_depreciation set depreciated_total=asset_total where wdv=0.0  and ast_id in(select id_wh from A_Ware_House where st_lease in ('NoLease','NUL'))");
    } catch (Exception localException2) {

...
public class SLMLOAYearlyDepCalcUL
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update stline_depreciation set depreciated_total=asset_total where wdv=0.0  and ast_id in(select id_wh from A_Ware_House where st_lease in ('Lease','UL'))");
    } catch (Exception localException2) {

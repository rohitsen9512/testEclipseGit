...
public class WDVYearlyDepCalcUL
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update stline_depreciation set depreciated_opening=(depreciated_opening-(Depreciated_total-asset_total)),wdv=0.0 where asset_total < = depreciated_total and ast_id in(select ast_id from hardware_register where leasestatus in ('Lease','UL'))");
    } catch (Exception localException2) {

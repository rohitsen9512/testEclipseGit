...
public class SLMLOAMonthDepCalcNUL
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update month_depreciation set depreciated_total=asset_total where wdv=0.0  and ast_id in(select ast_id from A_Ware_House where st_lease in ('NoLease','NUL'))");
    } catch (Exception localException2) {

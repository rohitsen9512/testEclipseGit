...
public class YearlyDepCalcUL
{
  ...
  public void transfer_calculateDep(String paramString1, String paramString2,HttpServletRequest request) throws Exception {
    ...
    try
    {
      ...
      localStatement1.executeUpdate("update stline_depreciation set depreciated_opening=(depreciated_opening-(Depreciated_total-asset_total)),wdv=0.0 where asset_total < = depreciated_total  and ast_id in(select id_wh from A_Ware_House where st_lease in ('Lease','UL'))");
    } catch (Exception localException2) {

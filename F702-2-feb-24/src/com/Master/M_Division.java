...
public class M_Division extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			System.out.println("Error in M_Division.");
		}
		finally
		{
			try {
	...
	public JSONObject CheckExitsVal(String value , String ColName)
	{
		...
		String query = "select id_div from M_Company_Division where "+ColName+" = '"+value+"'";
		try 
		{
	...
	public JSONObject DropDownResult()
	{
		JSONObject jobj = new JSONObject();
		JSONArray jarr = new JSONArray();
		String sql="select id_div,nm_div from M_Company_Division order by nm_div";
		...
		{
			System.out.println("sql error in M_Division.");
		}
	...
	public JSONObject DeleteDivision(String id)
	{
		JSONObject json=new JSONObject();
		int j=0;
		String query = "delete M_Company_Division where id_div = "+id+"";
		try 
		{
	...
	public JSONObject DisplayDivision(String id)
	{
		JSONObject jobj = new JSONObject();
		JSONArray jarr = new JSONArray();
		String sql="select * from M_Company_Division";
		if(!id.equals("0"))
		{
			sql +=" where id_div = "+id+"";
		}

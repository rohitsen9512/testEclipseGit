...
public class M_Consumable_Sub_Div extends HttpServlet {
	...
	public JSONObject DisplaySubassetDiv(String id)
	{
		JSONObject jobj = new JSONObject();
		JSONArray jarr = new JSONArray();
		String sql="select sd.*,nm_assetdiv from M_Subasset_Div sd , M_Asset_Div ad where sd.id_assetdiv=ad.id_assetdiv and type_grp='ConG'";
		if(!id.equals("0"))
		{

...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#"> Reports > </a><a href="#"> SEZ Annexure Report</a>-->
</div>

<div class="commonDiv" id="displayAnnexXXiReport">
<form action="ReportView/S_Sez_Annex_ReportView_xxi.jsp" method="post" target="_new">	
			...
			<tr>
				<td colspan="4" align="center">
					<p style="margin-left: 250px;">
						<button type="submit"   class="btn btn-primary" onclick="return SEZAnnexReport()">Preview</button>
					</p>
				</td>
		  </tr>
	</table>

...
<div class="card">
<form action="ReportView/TransferRequest_ReportView.jsp" method="POST" target="_new">

<div class="commonDiv" id="displayTransferReport">
<div class="card-body">
	<div class="card-small">
	<div class="card-header new">
					<h3 class="card-title1">Transfer Request Report</h3>
				</div>
	<table class="table table-bordered ">
	
		<!-- <table class="" align="center" width="600px" height="100%" border="1">
			<tr>
				<td colspan="5" class="tableHeader"><p class="tableHeaderContent" style="margin-left:200px">Transfer Request Report</p></td>
			</tr> -->
			<!-- <tr>

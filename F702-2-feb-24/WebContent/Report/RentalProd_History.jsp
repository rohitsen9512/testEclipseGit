			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<!-- <ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item">Rental Product History Report</li>
					</ol> -->
				</div>
			</div>
		</div>
...
<form action="ReportView/RentalProd_HistoryReport.jsp" method="POST" target="_new">

<div class="commonDiv" id="displayRentProductReport">
	<div class="card-body">
	<div class="card-small">
	<div class="card-header new">
	<h3 class="card-title1">Rental Product History Report</h3>
				</div>

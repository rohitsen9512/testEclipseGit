...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#"> Reports ></a><a href="#">Financial reports ></a><a href="#">Yearly FA For IT</a>-->
</div>
...
<div class="commonDiv" id="displayYearlyFaForIT">
<form action="ReportView/Yearly_Fa_Report_View_IT.jsp" method="POST" target="_new" name="Yearly_Fa_Report_IT" id="Yearly_Fa_Report_IT">
	...
	<table class="table table-bordered ">
		...
		<!-- <table class="commonTable" align="center" width="600px" border="1">
			...
			<tr>
				...
				<td >
					<select id="assetDivForFaYearlyReport" class="form-control" name="group_name" >
			...
			<tr>
				...
				<td >
					<select id="financialYearDataForReport" class="form-control" name="fin_year" >
						<option value="">Select</option>
					</select>
				</td>
			</tr>

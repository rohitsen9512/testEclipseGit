...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#"> Report ></a><a href="#">Approve Indent Report ></a> -->
</div>
<style type="text/css">
@media print
{
...
<form action="ReportView/Approve_indentView.jsp" method="post" target="_blank">	
		<table align="center" width="600px" height="100%" border="1">
			<tr>
				<td colspan="4" style="background-color: blue;"><p style="font-size: 24px;background-color: blue;color: white;margin-left: 170px;">Select Indent Date</p></td>
			</tr>
			<tr>

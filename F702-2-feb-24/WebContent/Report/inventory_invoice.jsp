...
<form action="ReportView/inventory_invPurchase.jsp" method="POST" target="_new">

<div class="commonDiv" id="displayRentProductReport">
	<div class="card-body">
	<div class="card-small">
	<div class="card-header new">
	<h3 class="card-title1">Purchase Invoice  History Report</h3>
				</div>
		<table class="table table-bordered ">
			...
			<tr>
				...
				<tr><td ><b>City<font color="red">*</font></b></td>
				<td >

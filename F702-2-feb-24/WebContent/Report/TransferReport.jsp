...
<div class="commonDiv" id="displayStoresAsset">
	...
	<div class="card-header new">
					<h3 class="card-title1">Transfer Report</h3>
				</div>
...
<div class="commonDiv" id="displayTransferReport">
		...
		<!-- <table class="" align="center" width="600px" height="100%" border="1">
			...
			<tr>
				...
				<td>
					<select id="assetDivForTransferReport" name="id_loc" class="form-control select2search"  style="width:140" onChange="SubDropDownDataDisplayForReport(this,'assetStateForTransferReport','M_Subloc')">
			...
			<tr>
				...
				<td>
					<select id="assetStateForTransferReport"  name="id_sloc" class="form-control select2search"  style="width:140" onChange="DisplaySubDropDownDataForReport(this,'assetCityForTransferReport','M_Building')">
			...
			<tr id="hideShowFloor">
				...
				<td><b>Floor</b></td>
				<td>
					<select id="assetStoreForFloorTransferReport" name="id_flr"  class="form-control select2search"  style="width:140"> 
						<option value="">Select</option>
			...
			<tr>
				...
				<td>
					<select id="assetGrpForTransferReport" name="id_grp"  class="form-control select2search" style="width:140" onChange="DisplaySubDropDownDataForReport(this,'subAssetSubGrpForTransferReport','M_Subasset_Div')">
						<option value="">Select</option>
			...
			<tr>
				...
				<td>
					<select id="subAssetSubGrpForTransferReport" name="id_sgrp" class="form-control select2search"   style="width:140">
						<option value="">Select</option>

...
$(function (){
	...
	DropdownResultForFinanceYear('financialYearDataForConslidatedCAReport');
});
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item">Consolidated CA</li>
					</ol>
				</div>
			</div>
		</div>
...
<form action="ReportView/consolidated_ca_reports.jsp" method="post" target="_new">	
<div class="card-body">
	...
	<table class="table table-bordered ">	
		<!-- <table class="commonTable" align="center" width="600px" border="1">
			...
			<tr>
				...
				<td >
					<select name="fin_years" class="form-control" id="financialYearDataForConslidatedCAReport" required>

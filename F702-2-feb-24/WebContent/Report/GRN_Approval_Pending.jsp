...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#"> Reports > GRN Report ></a><a href="#">Pending GRN Approval</a>-->
</div>

<div class="commonDiv" id="displayGRNApprovalReport">
<form action="ReportView/GRN_Approval_Pending_Report.jsp" method="post" target="_new">	

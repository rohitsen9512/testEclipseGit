...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#"> Transfer > </a><a href="#">Inter Transfer Approval Finance</a>-->
</div>
...
<div class="commonDiv" id="displayAssetForIntraUnitTransferRequestApproval">
	<!-- <input type="text" name="search" value="" placeholder="Search......" onkeyup="DisplayForInterTransferApprovalByFinance()">
	 -->	

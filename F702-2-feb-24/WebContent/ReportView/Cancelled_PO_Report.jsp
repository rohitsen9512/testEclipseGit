...
<title>Cancelled PO Report</title>
...
<div id="CancelledPOReportView">
		...
		String Group_id="",fin_id="",curr="";
			...
			try
			{
				...
				sql="Select p.no_po,(replace(convert(NVARCHAR, p.dt_po, 103), ' ', '-')) as dt_po,p.tot,p.rem_val_po,p.typ_pmt,p.no_quot,e.nm_emp"+
						" from P_Purchase_Order p,M_Emp_User e"+
						" where p.cancel_by=e.id_emp_user and p.cancel=1 "+tempSql+"" ;
		...
		<table border="1" width="100%" height="100%">
				<tr>
					<td colspan="9" style="background-color: blue;" width="100%"><p  style="background-color: blue; font-size: 24px;color: white;margin-left: 50%;">Cancelled PO Report</p></td>
				</tr>	
				<tr>
					...
					<td style="background-color: lavender;"><strong>SAP No.</strong></td>
					...
					<td style="background-color: lavender;"><strong>Cancelled By</strong></td>
				</tr>	
...
{
%>
<a href="Cancelled_PO_Report.jsp?exportToExcel=YES&enddate=<%=enddate%>&startdate=<%=startdate%>">

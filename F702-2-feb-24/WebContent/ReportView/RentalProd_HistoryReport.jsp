...
<title>Rental Product History Report</title>
...
<body>
	...
	<%
		...
		String Group_id="",fin_id="";
			...
			try
			{
				...
				//tempSql7="and led_m.dt_ld >='"+enddate+"' ";
				tempSql7=enddate;		  
				}
				...
				else
				{
					...
					tempSql1 =" and  led_m.id_sloc="+id_subl+"";
				}
				...
				if(UserType.equals("Super"))
				{
				  ...
				  sql="select distinct led_m.lead_no,led_m.nm_pstn,led_m.pstn_ct,led_m.adhar_no,led_m.address ,led.sr_no,led.nm_prod,ms.nm_subl ,"
						 +" l.nm_loc, (replace(convert(VARCHAR, led_m.dt_ld, 106), ' ', '-')) as dtld,"
						 +"(replace(convert(VARCHAR, rt.dt_return_str, 106), ' ', '-')) as dt_rt from "
						  +"O_Assign_Lead_Master led_m,O_Return_To_Store rt,O_Assign_Lead led ,"
						  +"M_Subloc ms, M_Loc l where led.typ_service='Rental' and led_m.state ='Closed' "
						  +"and led_m.id_sloc=ms.id_sloc and led_m.id_loc=l.id_loc and led_m.id_lead_m=led.id_lead_m and led.id_lead=rt.id_lead and  led_m.id_lead_m=rt.id_lead_m     " +tempSql1+"  " +tempSql2+" and led_m.dt_ld BETWEEN '"+tempSql +"' and '"+tempSql7 +"'";
	...
	<table id="RentalProdHistoryReport"
		...
		<thead><tr>
			...
			<th><strong><center>Return Date</center></strong></th> 
		 </tr>
		 </thead>
		 <tbody>
	...
	%>		
 		<tr>
			...
			<td><center><%=rs.getString("dtld")%><center></td>
			<td><center><%=rs.getString("dt_rt")%><center></td>

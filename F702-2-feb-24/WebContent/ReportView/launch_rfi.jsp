...
<div id="PreviewGRNClosedReport">
		...
		String Group_id="",fin_id="";
			...
			try
			{
				...
				String UserType = (String)session.getAttribute("UserType");
					sql="select distinct pf.no_rfi,(replace(convert(NVARCHAR, dt_rfi, 103), ' ', '-')) as dt_rfi,qty,nm_model "+
							"  ,nm_ven from m_vendor ven, p_rfi pf ,   P_RFI_Asset pfa , m_model md,P_Launch_RFI plf where ven.id_ven=plf.id_ven and pf.id_rfi=plf.id_rfi and pfa.id_prod=md.id_model and"+ 
							"   pf.id_rfi=pfa.id_rfi     and dt_rfi >='2021-03-07' and dt_rfi <= '2021-04-07' "+
		...
		<table border="1" width="100%" height="100%">
				...
				<tr >
					<td colspan="5" style="background-color: blue;" width="100%"><p  style="background-color: blue; font-size: 24px;color: white;margin-left: 500px;">Launched RFI Report</p></td>
				</tr>	
				<tr>

...
<title>GRN Approval Pending Report</title>
...
<div id="PreviewGRNApprovePendingReport">
		...
		String Group_id="",fin_id="";
		        ...
		        if (exportToExcel != null
		            ...
		            response.setHeader("Content-Disposition", "inline; filename="
		                    + "GRN_Approval_Pending_Report.xls");
		...
		<table border="1" width="150%" height="100%">
				...
				<tr >
					<td colspan="20" style="background-color: blue;" width="100%"><p  style="background-color: blue; font-size: 24px;color: white;margin-left: 500px;">GRN Approval Pending Report</p></td>
				</tr>	
				<tr>

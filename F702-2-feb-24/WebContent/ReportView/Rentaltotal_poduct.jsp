...
<body>
		...
		String Group_id="",fin_id="";
		        ...
		        if (exportToExcel != null
		            ...
		            response.setHeader("Content-Disposition", "inline; filename="
		                    + "Toatal_Rental_Product_report.xls");
			...
			try
			{
				String tempSql = "" ,tempSql2="",tempSql3="",tempSql4="";
				...
				{
				  sql="select distinct led.* ,led_m.*,ms.nm_subl ,l.nm_loc,(replace(convert(VARCHAR, led_m.dt_ld, 106), ' ', '-')) as dt_ld, (replace(convert(VARCHAR, led.dt_exp_rent, 106), ' ', '-')) as dtexpinstall from O_Assign_Lead_Master led_m,O_Assign_Lead led , M_Subloc ms,M_Loc l where led.typ_service='Rental' and led_m.state ='Inprogress' and led_m.tagto_me_state ='Inprogress' and  led_m.id_sloc=ms.id_sloc and led_m.id_loc=l.id_loc and led_m.id_lead_m=led.id_lead_m  " +tempSql+" " +tempSql2+" and led_m.dt_ld BETWEEN '"+tempSql3 +"' and '"+tempSql4 +"'" ;
	...
	<table id="RentalProdHistoryReport"
		...
		<thead><tr>
			...
			<th><strong><center>Rental Expire Date</center></strong></th> 
		 </tr>
		 </thead>
		 <tbody>
	...
	%>		
		...
		<td><center><%=rs.getString("nm_loc")%><center></td>
			...
			<td><center><%=rs.getString("dtexpinstall")%><center></td>

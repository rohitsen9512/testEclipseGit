...
<title>Sub-Location Asset Report</title>
<style type="text/css">
.headerTR{
...
<div id="PreviewEmployeeAssetReport">
		...
		<%
				...
				String id_subl ="";
					...
					try
					{
						...
						else
						{
							...
							tempSql1 =" and  wh.id_subl="+id_subl+"";
						}
				...
				sql="select  id_wh_dyn,ds_pro,serial_no as no_mfr,l.nm_loc, sl.nm_subl,dt_alloc,mdl_num,process_typ,storeage_typ,ram_typ ,device_status from A_Ware_House wh , M_Loc l,M_Subloc sl where   l.id_loc=wh.id_loc and sl.id_sloc=wh.id_subl "+tempSql+" "+tempSql1+"  order by dt_alloc";
	...
	<table id="SubAssetReport"
		class="table table-bordered table-hover SubAssetReport">
		<!-- <table style="border: 1px solid white;" border="1" width="100%" height="100%">
		
				<tr >
					<td colspan="16" class="headerTR"><p class="tableHeaderContent" style="font-size: 24px;color: white;margin-left: 500px;">Sub-Location Asset Detail Report</p></td>
				</tr> -->	
				<thead><tr>
	    ...
	    %>
	    <%-- <td colspan="12">
				<a href="Subloc_Asset_Report.jsp?exportToExcel=YES&id_loc=<%=id_loc%>&id_subl=<%=id_subl%>">
...
getButtonsForListView('SubAssetReport','Sub_Location_Asset_Report_Lists');
/* $('.sorting').show();
$('.sorting1').show(); */
</script>
</html>
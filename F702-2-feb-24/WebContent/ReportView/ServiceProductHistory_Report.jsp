...
<body>
		...
		String Group_id="",fin_id="";
		        ...
		        if (exportToExcel != null
		            ...
		            response.setHeader("Content-Disposition", "inline; filename="
		                    + "Product_Service_History_report.xls");
			...
			try
			{
				...
				else
				{
					...
					tempSql2 =" and  sh.id_sloc="+id_subl+"";
				}
				...
				{
				  sql="select distinct nm_product,wh.serial_no,sh.rmk,ms.nm_subl,l.nm_loc, (replace(convert(NVARCHAR, sh.dt_snd_service, 103), ' ', '-')) as dtsnd ,(replace(convert(NVARCHAR, sh.dt_restore, 103), ' ', '-')) as dtrstr "
					+" from  S_I_Ware_House wh,  J_Servicing_history sh,M_Subloc ms,M_Loc l where  wh.id_product= sh.id_prod "
				   +" and wh.serial_no=sh.serial_no and sh.id_loc=l.id_loc and sh.id_sloc=ms.id_sloc "  +tempSql1+" " +tempSql2+" and sh.dt_snd_service BETWEEN '"+tempSql +"' and '"+tempSql3 +"'";
	...
	%>		
 		<tr>
			...
			<td><center><%=rs.getString("dtsnd")%><center></td>
...
getButtonsForListView('RentalProdHistoryReport','Product_Service_History_report');

...
<body>
	...
	<%
		...
		String Group_id="",fin_id="";
		        ...
		        if (exportToExcel != null
		            ...
		            response.setHeader("Content-Disposition", "inline; filename="
		                    + "Product_Refill_History_report.xls");
			...
			try
			{
				...
				{
					 sql="select led.prev_lead_no, led.lead_no,led.lead_no_refill,led.prev_sr_no,led.sr_no,led.sr_no_refill ,led.id_lead,led_m.id_lead_m ,led_m.nm_pstn,address,l.nm_loc,ms.nm_subl ,refill_status ,nm_assetdiv , (replace(convert(NVARCHAR, led_m.dt_ld, 103), ' ', '-')) as dt_ld "
							  +" from O_Assign_Lead led, O_Assign_Lead_Master led_m,M_Subloc ms,M_Loc l, M_Asset_Div ma  where  led.refill_status='yes' and  led_m.id_lead_m=led.id_lead_m and led_m.id_loc=l.id_loc and led_m.id_sloc=ms.id_sloc and led.id_prod= ma.id_assetdiv "  +tempSql1+" " +tempSql2+"  and led_m.dt_ld BETWEEN  '"+tempSql+"' and '"+tempSql3+"'";
				...
				else
				{
					...
					//String tempQuery2 = dtoCommon.MakeTempQuery(UserType ,"led_m","led_m",request);
					 sql="select led.prev_lead_no, led.lead_no,led.lead_no_refill,led.prev_sr_no,led.sr_no,led.sr_no_refill ,led.id_lead,led_m.id_lead_m ,led_m.nm_pstn,address,l.nm_loc,ms.nm_subl ,refill_status ,nm_assetdiv , (replace(convert(NVARCHAR, led_m.dt_ld, 103), ' ', '-')) as dtld "
							  +" from O_Assign_Lead led, O_Assign_Lead_Master led_m,M_Subloc ms,M_Loc l, M_Asset_Div ma  where  led.refill_status='yes' and  led_m.id_lead_m=led.id_lead_m and led_m.id_loc=l.id_loc and led_m.id_sloc=ms.id_sloc and led.id_prod= ma.id_assetdiv "  +tempSql1+" " +tempSql2+" and led_m.dt_ld BETWEEN  '"+tempSql+"' and '"+tempSql3+"'";
					  System.out.println(sql);
				}
		...
		<div id="RefillProdHistoryReportdiv">
			 <div class="card-body"> 
			
	<table id="RefillProdHistoryReport"
		...
		<thead><tr>
			 ...
			 <th><strong><center>Lead No</center></strong></th>
			  <th><strong><center>Lead No Refill</center></strong></th>
			 <th><strong><center>Serial No</center></strong></th> 
			<th><strong><center>Refill Serial No</center></strong></th>
			 <th><strong><center>Product</center></strong></th> 
		     <th><strong><center>Entity</center></strong></th>
			<th><strong><center>City</center></strong></th>
		     <th><strong><center>Name Patient</center></strong></th> 
		     <th><strong><center>Lead Date</center></strong></th> 
	...
	%>		
 		<tr>
			...
			<td><center><%=rs.getString("lead_no_refill")%><center></td> 
			
				<td><center><%=rs.getString("sr_no")%><center></td> 
		   <td><center><%=rs.getString("sr_no_refill")%><center></td> 
...
getButtonsForListView('RefillProdHistoryReport','Product_Refill_History_report');

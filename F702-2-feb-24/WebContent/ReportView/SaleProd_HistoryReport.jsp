...
<title>Sale Product History Report</title>
	...
	<%
		...
		String Group_id="",fin_id="";
			...
			{	
				...
				{
				  sql="select distinct led.* ,led_m.*,ms.nm_subl ,l.nm_loc,(replace(convert(VARCHAR, led_m.dt_ld, 106), ' ', '-')) as dtld from O_Assign_Lead_Master led_m,O_Assign_Lead led , M_Subloc ms, M_Loc l where led.typ_service='Sale' and led_m.state ='Closed' and  led_m.id_sloc=ms.id_sloc and led_m.id_loc=l.id_loc and led_m.id_lead_m=led.id_lead_m " +tempSql1+" " +tempSql2+" and led_m.dt_ld BETWEEN '"+tempSql +"' and '"+tempSql3 +"'";

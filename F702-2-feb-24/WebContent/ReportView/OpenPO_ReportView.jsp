...
<div id="CancelledPOReportView">
		...
		String Group_id="",fin_id="",curr="";
			...
			try
			{
				...
				sql="Select nm_ven,p.no_po,(replace(convert(NVARCHAR, p.dt_po, 103), ' ', '-')) as dt_po,p.tot,p.rem_val_po,p.typ_pmt,p.no_quot "+
						" from P_Purchase_Order p,m_vendor ven where ven.id_ven=p.id_ven and (recv_invoice=0 or recv_invoice=1) "+tempSql+"" ;
		...
		<table border="1" width="100%" height="100%">
				<tr>
					<td colspan="9" style="background-color: blue;" width="100%"><p  style="background-color: blue; font-size: 24px;color: white;margin-left: 50%;">Open PO Report</p></td>
				</tr>	
				<tr>
...
{
%>
<a href="OpenPO_ReportView.jsp?exportToExcel=YES&enddate=<%=enddate%>&startdate=<%=startdate%>">

...
<div id="PreviewAssetForLocAsset">
		...
		String Group_id="",fin_id="";
			...
			try
			{
				...
				String tempSql1 ="",tempSql3="",nmsgrp1="";
				...
				if(request.getParameter("id_sgrp")!=null){
					nmsgrp1="and nm_s_assetdiv='"+request.getParameter("id_sgrp")+"'";
				}

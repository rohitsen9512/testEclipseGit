...
<body>
	...
	<%
		...
		String Group_id="",fin_id="";
			...
			/* 	id_loc = request.getParameter("id_loc");
				...
				{
				  sql="select tm.id_Transfer_stock, (replace(convert(NVARCHAR, tm.dt_dc, 103), ' ', '-')) as dt_dc,"
						 +" l.nm_loc as toloc , l1.nm_loc as frmloc ,  tm.no_dc,"
						 +" tm.remarks,t.id_prod,t.nm_prod,t.ds_product,t.sr_no,t.transfer_by,t.quantity,t.un_prc, l.nm_loc as frm_loc,l1.nm_loc as to_loc,"
						 + "ms.nm_subl as frm_sloc,ms1.nm_subl as tosloc from T_Transfer_Stock_DC t,T_TRANSFER_DC_Master tm,M_loc l,M_Subloc ms,M_loc l1,M_Subloc ms1 where "
						  +"tm.id_Transfer_stock=t.id_Transfer_stock  and tm.frm_id_loc=l.id_loc  and tm.to_id_loc=l1.id_loc "
						  +"and tm.frm_id_sloc=ms.id_sloc  and tm.to_id_sloc=ms1.id_sloc  "+tempSql+" " +tempSql1+" and tm.dt_dc BETWEEN  '"+tempSql6+"' and '"+tempSql7+"'";
				...
				else
				{
					...
					//String tempQuery2 = dtoCommon.MakeTempQuery(UserType ,"led_m","led_m",request);
					  sql="select tm.id_Transfer_stock, (replace(convert(NVARCHAR, tm.dt_dc, 103), ' ', '-')) as dtdc,"
								 +" .nm_loc as toloc , l1.nm_loc as frmloc ,  tm.no_dc,"
								 +" tm.remarks,t.id_prod,t.nm_prod,t.ds_product,t.sr_no,t.transfer_by,t.quantity,t.un_prc, l.nm_loc as frm_loc,l1.nm_loc as to_loc,"
								 + "ms.nm_subl as frm_sloc,ms1.nm_subl as tosloc from T_Transfer_Stock_DC t,T_TRANSFER_DC_Master tm,M_loc l,M_Subloc ms,M_loc l1,M_Subloc ms1 where "
								  +"tm.id_Transfer_stock=t.id_Transfer_stock  and tm.frm_id_loc=l.id_loc  and tm.to_id_loc=l1.id_loc "
								  +"and tm.frm_id_sloc=ms.id_sloc  and tm.to_id_sloc=ms1.id_sloc  "+tempSql+" " +tempSql1+" and tm.dt_dc BETWEEN  '"+tempSql6+"' and '"+tempSql7+"'";
		...
		<thead><tr>
			 ...
			 <th><strong><center>Product Name</center></strong></th>
			  <th><strong><center>Serial No.</center></strong></th>
			   <th><strong><center>DC Number</center></strong></th>
			  <th><strong><center>From Entity</center></strong></th>
		     <th><strong><center>From City</center></strong></th>
		     <th><strong><center>To Entity</center></strong></th>
		     <th><strong><center>To City</center></strong></th>
	...
	%>		
 		<tr>
			...
			<td><center><%=rs.getString("frmloc")%><center></td>
			<td><center><%=rs.getString("frm_sloc")%><center></td>
			<td><center><%=rs.getString("toloc")%><center></td>
			<td><center><%=rs.getString("tosloc")%><center></td>
			<td><center><%=rs.getString("dt_dc")%><center></td>
...
getButtonsForListView('RentalProdHistoryReport','Stock Transfer report');

...
<body>
	...
	<%
		int slNo    =   0;
		String id_loc = "", id_subl = "",Source_Nm1="";;
		...
		String Group_id="",fin_id="";
			...
			try
			{
				...
				id_loc = request.getParameter("id_loc");
			     ...
			     Source_Nm1 = request.getParameter("pay_mode");
				 System.out.println(Source_Nm1);
				...
				if(Source_Nm1.equals("FOC"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				else if(Source_Nm1.equals("Cash"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				else if(Source_Nm1.equals("UPI"))
					
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				else if(Source_Nm1.equals("Credit"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				else if(Source_Nm1.equals("Cheque"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				else if(Source_Nm1.equals("NA"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}	else if(Source_Nm1.equals("Due"))
				{
					tempSql1 =" and  led_m.pay_mode='"+Source_Nm1+"'";
					System.out.println(tempSql1);
				}
				/* else
				{
					tempSql1 =" and  led_m.src="+Source_Nm1+"";
					System.out.println(tempSql1);
				}
				 */
				...
				{
				  sql="select distinct led_m.lead_no,led_m.nm_pstn,ms.nm_subl,l.nm_loc,led_m.pay_mode,del.cheque_no,(replace(convert(VARCHAR, led_m.dt_ld, 106), ' ', '-')) as dt_install,"
						+" (replace(convert(VARCHAR, del.dt_install, 106), ' ', '-')) as dt_expinstall from O_Assign_Lead_Master led_m,O_Assign_Lead led , M_Subloc ms,M_Loc l , " 
						  +"O_Deliver_Detail_Lead del where  led_m.tagto_me_state='inprogress' and  led_m.id_sloc=ms.id_sloc and led_m.id_loc=l.id_loc and led_m.id_lead_m=led.id_lead_m  "+tempSql3+" "+tempSql2+" "+tempSql1+" ";
		...
		<div id=SourceReportdiv">
			 <div class="card-body"> 
			
	<table id="SourceReportdiv"
		class="table table-bordered table-hover SourceReportdiv">
		...
		<thead><tr>
		  ...
		  <th><strong><center>Entity</center></strong></th>
			...
			<th><strong><center>Payment Mode</center></strong></th>
		...
		<%} 
 		...
 		<tr>
			...
			<td><center><%=rs.getString("pay_mode")%><center></td>
...
getButtonsForListView('SourceReportdiv','Master_Report_List');

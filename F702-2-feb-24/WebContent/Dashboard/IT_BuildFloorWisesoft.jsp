...
<div class="commonDiv" style="padding:10px;">
	<!-- <a href="#">Dashboard > </a><a href="#"> Sub Location Wise IT Software Asset Details </a> -->
</div>
...
<form id="formSelect">
		...
		<!-- <table class="commonTable" align="center" width="600px" height="100%" border="1">
			<tr>
				<td colspan="2" class="tableHeader"><p class="tableHeaderContent" style="margin-left:150px">Sub Location IT Asset Details</p></td>
			</tr> -->
			...
			<tr>
				...
				<td>
					<select id="buildingAssetReport" name="id_building"  style="width:140" onChange="DisplaySubDropDownData(this,'floorAssetReport','M_Floor')">
			
						
					</select>
				</td>
				<td><b style="color:green">Select Floor</b></td>
				<td>
					<select id="floorAssetReport" name="id_flr"  style="width:140">
			...
			$(document).ready(function(){
				...
				$('#btnClick').on('click',function(){
					...
					var ddlFruits = $("#assetDivForsubLocAsset");
					 ...
					 var ddlFruits = $("#floorAssetReport");
					 if (ddlFruits.val() == "") {
			                //If the "Please Select" option is selected display error.
			                alert("Please select an option!");
			                return false;
					 ...
					 var flr=$("#floorAssetReport option:selected").val();
					 console.log(abc+"btnClick");
					 //console.log(frl+"btnClick");
					 myChart(abc,building,flr);
				});
				
			});
			function myChart(submit,building,flr){
				var mainAr = Array();
				var key1 = new Array();
			   ...
			   // $(document).ready(function(){
					...
					$.ajax({
						...
						method:"GET",
						url:"IT_BuildFoorWiseSoft",
						data: {id_sloc: submit , id_building : building,id_flr:flr}
					}).done(function(data1){
			      ...
			      //  alert("in side chart function");
			        					$('#container').highcharts({
			           					  ...
			           					  exporting: {
			                                  ...
			                                  title: {
			                                              text: 'Sub Location Wise IT Software Asset Details'
			                                         },
			                                  tooltip: {

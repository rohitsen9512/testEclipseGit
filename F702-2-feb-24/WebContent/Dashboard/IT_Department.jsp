...
<div class="commonDiv" style="padding:10px;">
	<!-- <a href="#">Dashboard > </a><a href="#">Employee Wise IT Asset Details </a> -->
</div>
...
<!-- 		<table class="commonTable" align="center" width="600px" height="100%" border="1">
			...
			<tr> -->
				<td><b style="color:green">Select Employee</b></td>
				<td>
					<select id="departmentAsset"  name="id_emp_user"  style="width:140" >
			...
			function myChart(submit,frl){
				...
				console.log(value1[0]);
					...
					$.ajax({
						...
						method:"GET",
						url:"IT_DeptartmentWise",
						data: {id_emp_user: submit}
					}).done(function(data1){
			      ...
			      //  alert("in side chart function");
			        					$('#container').highcharts({
			           					  ...
			           					  exporting: {
			                                  ...
			                                  title: {
			                                              text: 'Employee Wise  Asset Details'
			                                         },
			                                  tooltip: {

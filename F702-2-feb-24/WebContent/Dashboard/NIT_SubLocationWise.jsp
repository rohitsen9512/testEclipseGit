...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#">Dashboard > </a><a href="#">Location Wise Non-IT Asset Details </a>-->
</div>
...
$(function (){
	...
	DropDownDataDisplay('M_Loc','assetDivForsubLocAsset',function (status){
		if(status)
		{
...
<form id="formSelect">
		...
		<!-- <table class="commonTable" align="center" width="600px" height="100%" border="1">
			<tr>
				<td colspan="2" class="tableHeader"><p class="tableHeaderContent" style="margin-left:166px">Location Non-IT Asset Details</p></td>
			</tr>
		
			<tr> -->
				<td><b style="color:green">Select Location </b></td>
				<td>
					<select id="assetDivForsubLocAsset"  name="id_loc"  style="width:140" required>
			      ...
			      //  alert("in side chart function");
			        					$('#container').highcharts({
			           					  ...
			           					  exporting: {
			                                  ...
			                                  title: {
			                                              text: 'Location Wise Non-IT Asset Details'
			                                         },
			                                  tooltip: {

...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#">Dashboard > </a><a href="#">Department Wise Status Asset Details </a>-->
</div>
...
<form id="formSelect">
	<!-- 
		<table class="commonTable" align="center" width="600px" height="100%" border="1">
			<tr>
				<td colspan="2" class="tableHeader"><p class="tableHeaderContent" style="margin-left:166px">Department Wise IT Asset Details</p></td>
			</tr>
			      ...
			      //  alert("in side chart function");
			        					$('#container').highcharts({
			           					  ...
			           					  exporting: {
			                                  ...
			                                  title: {
			                                              text: 'Department Wise Status Asset Details'
			                                         },
			                                  tooltip: {

...
<div class="item1">
 <b style="color:green">Asset Type</b>
		<select  name="typ_asst" data-valid="mand">
...
$('#btnClick').click(function(){
    ...
    url=currentLocation.slice(0, -9)+"ReportView/Location_Asset_report2.jsp?id_grp="+group+"&id_sgrp="+subgrp+"&id_model="+model+"&type="+typ_asst+"&label="+this.name+"";

    }
    else{
    url=currentLocation.slice(0, -8)+"ReportView/Location_Asset_report2.jsp?id_grp="+group+"&id_sgrp="+subgrp+"&id_model="+model+"&type="+typ_asst+"&label="+this.name+"";

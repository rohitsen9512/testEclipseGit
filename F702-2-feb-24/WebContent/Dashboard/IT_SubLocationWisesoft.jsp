...
<div class="commonDiv" style="padding:10px;">
	<!--  <a href="#">Dashboard > </a><a href="#">Location Wise IT Software Asset Details </a>-->
</div>
...
$(function (){
	...
	DisplayDropDownData('M_Loc','assetDivForLocAsset',function (status){
		if(status)
		{
...
<form id="formSelect">
		...
		<!-- <table class="commonTable" align="center" width="600px" height="100%" border="1">
			...
			<tr>-->
				...
				<td>
					<select id="assetDivForLocAsset"  name="id_loc"  style="width:140" required>
			      ...
			      //  alert("in side chart function");
			        					$('#container').highcharts({
			           					  ...
			           					  exporting: {
			                                  ...
			                                  title: {
			                                              text: 'Location Wise IT Software Asset Details'
			                                         },
			                                  tooltip: {

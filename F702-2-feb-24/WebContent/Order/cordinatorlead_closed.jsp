...
<script type="text/javascript">
	$(function() {
		...
		DisplayCrClosedLead('O_AssignedLlead', 'displayCrClosedLead', 'EditCrClosedLead', '','submitCrclosedLead',
				'leadCrClosedForDisplaytd');
	...
	function DisplayRestoreFill1(idloc){
		debugger;
				 setTimeout(function() {
					 DisplayCrClosedLead('O_AssignedLlead', 'displayCrClosedLead', 'EditCrClosedLead', '','submitCrclosedLead',
						'leadCrClosedForDisplaytd');
			...
			<div class="col-sm-6">
			 <!-- 	<h1>
					...
					<button type="button" name="create btn" class="btn btn-primary led hideCrled"
						onclick="ControlCrLead('Create','displayCrClosedLead','createCrLead','submitCrclosedLead','O_AssignedLlead')">Create
						Lead</button>
				</h1> --> 
			</div>
			<div class="col-sm-6">
	...
	<div id="displayCrClosedLead">
				...
				<tr>
					...
					<td>
						<button type="button" style="margin-top: 10px; margin-left: 25px;"
							...
							onclick="DisplayCrClosedLead('O_AssignedLlead', 'displayCrClosedLead', 'EditCrClosedLead', '','submitCrclosedLead',
								'leadCrClosedForDisplaytd')">Search
						</button>
					</td>
				</tr>
				<tr></tr>
		...
		<tr class="new backcolor">
										<!-- <td colspan="2">
											...
											<select id="empdataforAddedBy" class="Commonforservice form-control" name="fill_add_by" style="width: 400px;" onchange="getDATAFromEMPuser1(this)">
											...
											<select id="locdataforfillstock" class="Commonforservice form-control" name="id_loc" style="width: 300px;" onChange="DisplaySubDropDownData(this,'slocdataforfillstock','M_Subloc')" >
											...
											<select id="slocdataforfillstock" class="Commonforservice form-control" name="id_sloc" style="width: 200px;" onChange="DisplayRestoreFill1($(id_sloc).val())" >
			...
			<table id="leadCrClosedForDisplaytd"
				class="table table-bordered table-hover leadCrClosedForDisplaytd">
...
<div class="card">
<div id="EditCrClosedLead" style="display: none;">
	
		<form name="submitCrclosedLead" id="submitCrclosedLead">
						...
						<table class="table table-bordered" id="leadCrrDetails">
							...
							<!-- 		<input id="invoiceId" type="hidden" name="invoiceId" value=""
									...
									<button name="cancel" type="button"  style="margin-left: 500px;" class="btn btn-primary inv"
										onclick="ControlCrCloseLead('Cancel','displayCrClosedLead','EditCrClosedLead','submitCrclosedLead','O_AssignedLlead','')">Back</button>

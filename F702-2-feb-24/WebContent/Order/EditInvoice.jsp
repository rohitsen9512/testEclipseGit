...
<script type="text/javascript">
	$(function() {
		...
		DisplayEditInvoice('O_CreateInvoiceLead', 'displayEditInvoice', 'EditInvoice', '','submitEditInvoice',
				'EditInvoiceForDisplaytd');
		$('button[name="update"]').addClass('hideButton');
		$('button[name="save1"]').addClass('hideButton');
								DropDownDataDisplay("M_Loc","locDataForLead",function(status) {
																					if (status) {
																						DisplayDropDownData("M_Emp_User","empdataforeditByInv",function(status) {
																							if (status) {
...
<div class="card">
	<div id="displayEditInvoice">
		<div class="card-body">
		
			<table id="EditInvoiceForDisplaytd"
				class="table table-bordered table-hover EditInvoiceForDisplaytd">
				<thead>
					<tr class="new">
...
<div id="EditInvoice" style="display: none;">
		...
		<form name="submitEditInvoice" id="submitEditInvoice"
			...
			<div id="EditInvLead">
				...
				<table class="table table-bordered" id="InvoiceDetails">
					<tr>
						...
						<td><input type="text" name="dt_po" value=""
							class="form-control readbaledata datepicker" readonly data-valid="mand" placeholder="chose only from the datepicker. Do not paste any data."></td>
					</tr>
					<tr>
						...
						<tr>
							 <td><b>Update By<font color="red">*</font>
					<td><select id="empdataforeditByInv" name="edit_by"
					 ...
					 <input type="hidden" name="id_fincance" value="" class="form-control"> 
		           ...
		           <td><strong>Patient Name<font color="red">*</font></strong></td>
				    <td><input id="nm_pstn" class="form-control" type="text" name="nm_pstn" readonly data-valid="mand" onkeyup="this.value = this.value.toUpperCase();"></td>
					</tr>
					<tr>
				...
				<td><input id="address" class="form-control" type="text" name="address" readonly data-valid="mand" onkeyup="this.value = this.value.toUpperCase();"></td>
					</tr>
							...
							<tr>
								<td colspan="4"><input type="hidden" name="itemCount" value="10"> 
									...
									<input type="hidden" name="leadCheck" value="0">
										...
										onclick="ControlCreateInvoice('Update','displayEditInvoice','EditInvoice','submitEditInvoice','O_CreateInvoiceLead')">Update</button>
									<button name="cancel" type="button" class="btn btn-primary inv"
										onclick="ControlCreateInvoice('Cancel','displayEditInvoice','EditInvoice','submitEditInvoice','O_CreateInvoiceLead')">Back</button>

					...
					DisplayDropDownData("M_Emp_User","empForNewTicketHD",function (status){
						if(status)
						{
							DisplayDropDownData('M_Designation','id_design',function (status){
								if(status)
								{
		ControlIncident('List','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','New_Incident','displayDataForNewIncident','','');
								if(status)
									{
									listToBeParent();
									}
		...
		<div class="container-fluid">
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					...
					<button name="update" type="button" style="margin-left:2px;"   class="btn btn-primary update" onclick="ControlIncident('Update','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','Assign_To_Me_Incident','','','')">Update</button>
						<!-- <button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlIncident('Cancel','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','Assign_To_Me_Incident','','','')">Cancel</button>
				 <button name="delete"   type="button"  class="btn btn-primary delete" onclick="ControlIncident('Delete','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','Assign_To_Me_Incident','','','')">Delete</button>
					--> 
					<!-- Modal -->
...
<div class="card-body">
				<table id="displayDataForNewIncident"
					class="table table-bordered table-hover displayDataForNewIncident">
...
<div class="card">
	<form name="SubmitFormForEditNewIncident" id="SubmitFormForEditNewIncident" onsubmit="return validateFormData(this)">
...
<table>
			...
			<tr>
					...
					<td colspan="4">
						...
						<button name="update" type="button"    class="btn btn-primary update" onclick="ControlIncident('UpdateAssign','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','Assign_To_Me_Incident','','','')">Update</button>
						<!-- <button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlIncident('Cancel','DisplayNewIncident','EditDetailsForNewIncident','SubmitFormForEditNewIncident','Assign_To_Me_Incident','','','')">Cancel</button>

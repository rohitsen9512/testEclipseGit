					...
					DisplayDropDownData("M_Emp_User","empForNewTicketHD",function (status){
						if(status)
						{
							DisplayDropDownData('M_Designation','id_design',function (status){
								if(status)
								{
		ControlIncident('List','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','New_Incident','displayDataForHoldIncident','','');
								if(status)
									{
									listToBeParent();
									}
...
/* }}); */
	...
	$('#EditDetailsForHoldIncident').hide();
...
<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
				<h1>
					<button class="btn btn-primary" onclick="back('open')"> <i class="fas fa-chevron-left"></i></button>
				...
				<div class="col-sm-6">
					...
					<button name="update" type="button" style="margin-left:2px;"   class="btn btn-primary update" onclick="ControlIncident('Update','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','Assign_To_Me_Incident','','','')">Update</button>
						<!-- <button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlIncident('Cancel','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','Assign_To_Me_Incident','','','')">Cancel</button>
				 <button name="delete"   type="button"  class="btn btn-primary delete" onclick="ControlIncident('Delete','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','Assign_To_Me_Incident','','','')">Delete</button>
					--> 
					<!-- Modal -->
...
<div class="card">
<div id="DisplayHoldIncident">
<div class="card-body">
				<table id="displayDataForHoldIncident"
					class="table table-bordered table-hover displayDataForHoldIncident">
...
<div id="EditDetailsForHoldIncident" >
<div class="card">
	<form name="SubmitFormForEditHoldIncident" id="SubmitFormForEditHoldIncident" onsubmit="return validateFormData(this)">
...
<table>
			...
			<tr>
					...
					<td colspan="4">
						...
						<button name="update" type="button"    class="btn btn-primary update" onclick="ControlIncident('UpdateAssign','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','Assign_To_Me_Incident','','','')">Update</button>
						<!-- <button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlIncident('Cancel','DisplayHoldIncident','EditDetailsForHoldIncident','SubmitFormForEditHoldIncident','Assign_To_Me_Incident','','','')">Cancel</button>

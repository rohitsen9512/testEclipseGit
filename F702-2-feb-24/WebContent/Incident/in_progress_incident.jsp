...
/* 	DisplayDropDownDataForGroup('M_Asset_Div','requestPrAssetGroup','CapG',function (status){
					...
					DisplayDropDownData("M_Emp_User","empForNewTicketHD",function (status){
						if(status)
						{
							DisplayDropDownData('M_Designation','id_design',function (status){
								if(status)
								{
		ControlIncident('List','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncident','New_Incident','displayDataForEditInProgressIncident','','');
								/* }}); */
	...
	$('#EditDetailsForInProgressIncident').hide();
		...
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6"><h1>
					<button class="btn btn-primary" onclick="back('in_progress')"> <i class="fas fa-chevron-left"></i></button>
				...
				<div class="col-sm-6">
					...
					<button name="update" type="button" style="margin-left:2px;"   class="btn btn-primary update" onclick="ControlIncident('Update','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncidents','In_Progress_Incident','','','')">Update</button>
					<!-- 	<button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlIncident('Cancel','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncidents','In_Progress_Incident','','','')">Cancel</button>
					<button name="delete" type="button"  class="btn btn-primary delete" onclick="ControlIncident('Delete','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncidents','In_Progress_Incident','','','')">Delete</button> -->
					<!-- Modal -->
...
<div class="card">
<div id="DisplayInProgressIncident">
<div class="card-body">
				<table id="displayDataForEditInProgressIncident"
					class="table table-bordered table-hover displayDataForEditInProgressIncident">
...
<div id="EditDetailsForInProgressIncident">
<div class="card">
	<form name="SubmitFormForEditInProgressIncidents" id="SubmitFormForEditInProgressIncidents">
...
<table>
			...
			<tr>
					...
					<td colspan="4">
						...
						<button name="update" type="button"  class="btn btn-primary update" onclick="ControlIncident('UpdateAssign','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncidents','In_Progress_Incident','','','')">Update</button>
						<!-- <button name="cancel" type="button"  class="btn btn-primary cancel" onclick="ControlIncident('Cancel','DisplayInProgressIncident','EditDetailsForInProgressIncident','SubmitFormForEditInProgressIncidents','In_Progress_Incident','','','')">Cancel</button>
...
<div class="card">
<div id="DisplayInProgressIncidentforProblem">
<div class="card-body">
				<table id="displayDataForEditInProgressIncidentforProblem"
					class="table table-bordered table-hover displayDataForEditInProgressIncidentforProblem">

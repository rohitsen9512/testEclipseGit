					...
					DisplayDropDownData("M_Emp_User","empForNewTicketHD",function (status){
						if(status)
						{
							/* DisplayDropDownData("M_Emp_User","empForAssignToHD",function (status){
								if(status)
								{ */
		ControlHelpDesk('List','DisplayNewTicket','EditDetailsForNewTicket','SubmitFormForEditNewTickets','New_Ticket','displayDataForNewTicket','','');
								}});
						/* }}); */
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item">Assigned Ticket</li>
					</ol>
				</div>
			</div>
		</div>
...
<div class="card">
<div id="DisplayNewTicket">
<div class="card-body">
				<table id="displayDataForNewTicket"
					class="table table-bordered table-hover displayDataForNewTicket">
...
<div id="EditDetailsForNewTicket" class="card ">
	<form name="SubmitFormForEditNewTickets" id="SubmitFormForEditNewTickets">
		...
		<tr>
			...
			<tr>
					...
					<td colspan="4">
						...
						<button name="update" type="button" style="margin-left:400px;"   class="btn btn-primary update" onclick="ControlHelpDesk('Update','DisplayNewTicket','EditDetailsForNewTicket','SubmitFormForEditNewTickets','Assign_To_Me_Ticket','','','')">Update</button>
						<button name="cancel" type="button"  class="btn btn-primary update" onclick="ControlHelpDesk('Cancel','DisplayNewTicket','EditDetailsForNewTicket','SubmitFormForEditNewTickets','Assign_To_Me_Ticket','','','')">Cancel</button>
					</td>
				</tr>

...
$('#cd_vendorId').keyup( function(){
	...
	<div id="displayVendor" style="display:none;">
		...
		<table width="100%" height="100%">
			...
			<input type="text" name="searchWord" value="" placeholder="Search......" onkeyup="DisplayData('M_Vendor','displayVendor','createVendor')">
					...
					<button type="button" style="float:left;"  class="btn btn-primary" onclick="openSendLinkDiv()">Send Link</button>
				</td>
			</tr>
			<tr>
				<td>
	...
	<form name="submitVendor" id="submitVendor">
		...
		<tr>
			...
			<td ><input type="text"  name="fax" value=""  class="common-validation" data-valid="num"></td>
		    
			<td  ><b>TIN Number <font color="red">*</font> </b></td>

      		<td  ><input type="text"  name="tin"  class="common-validation" data-valid="num"></td>
		...
		<tr>
			...
			<td ><input type="text"  name="kst" value=""  class="common-validation" data-valid="num"></td>

			
			<td ><b>MSME Number <font color="red">*</font> </b></td>

			<td ><input type="text"  name="cst"  value="" class="common-validation" data-valid="num"></td>
		...
		<tr>
			...
			<td ><input type="text"  name="servicetax" value=""  class="common-validation" data-valid="num"></td>
		...
		<tr>
			<td  colspan="4">
				<button name="save" type="button" style="margin-left:700px;"   class="btn btn-primary" onclick="ControlDiv('Save','displayVendor','createVendor','submitVendor','M_Vendor','Vendor name already exist.,,Vendor code already exist.' , 'nm_ven,,cd_ven');">Save</button>
				<button name="update" type="button" style="margin-left:700px;px;"   class="btn btn-primary" onclick="ControlDivPartner('Update','displayVendor','createVendor','submitVendor','M_Vendor','' , '')">Update</button>
				<!-- <button name="cancel" type="button"  class="btn btn-primary" onclick="ControlDiv('Cancel','displayVendor','createVendor','submitVendor','M_Vendor');">Cancel</button>
				 -->	
			</td>
		</tr>
	...
	<table>
	<tr>	
		 <td ><b>Partner Name<font color="red">*</font></b></td> 
				<td><input type="text"  name="link"   value="" class="common-validation" data-valid="mand" ></td>
		   		</tr>
		   		<tr>
			<td >
				<button name="send" type="button" style="margin-left:450px;"   class="btn btn-primary" onclick="ControlDiv1();">Send</button>
				<button name="cancel" type="button"  class="btn btn-primary" onclick="ControlDiv1();">Cancel</button>

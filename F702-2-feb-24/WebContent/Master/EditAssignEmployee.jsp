...
<div class="card">
					...
					<form action="" name="submitgroup" id="submitgroup">
						<table class="table table-bordered ">
							...
							<tr>
								...
								<td><input id="nm_grpId" class="form-control readonly"
									type="text" name="nm_grp" readonly="readonly" data-valid="mand"></td>
							</tr>
							<!-- <tr>
							...
							<!-- <tr>
								<td colspan="2">
									<button name="save" type="button" style="margin-left: 200px;"
										...
										onclick="ControlDiv('Save','displayGroup','createGroup','submitgroup','M_Group','Location name already exist.','nm_grp')">Save</button>
									...
									<button name="cancel" type="button" class="btn btn-primary"
										onclick="ControlDiv('Cancel','displayGroup','createGroup','submitgroup','M_Group')">Cancel</button>
	...
	<div class="card" >
<div class="card-body">
<div class="commonDiv" id="displayEmpForBulkuninstallSearch">
	<!-- <input type="text" name="search" value="" placeholder="Search......" onkeyup="EditEmpFun('M_Group')">
	 -->
	

</div>
			<form name="bulkuninstallEmp" id="bulkuninstallEmp">
		<div id="DisplayEmpForBulkUninstall"style="display: none;">
		
		<input type="hidden" name="action" value="UpdateEMPGroup">
		...
		<table class="table table-bordered DisplayEmpForBulkUninstall">
